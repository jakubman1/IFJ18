...
#define PUSH_RULE_1 s_pop(stack); s_push(stack, LL_EOL); s_push(stack, LL_END); s_push(stack, LL_STATEMENT);s_push(stack, LL_EOL); s_push(stack, LL_PARAMS); s_push(stack, LL_ID); s_push(stack, LL_DEF)
#define PUSH_RULE_2 s_pop(stack); s_push(stack, LL_STATEMENT)
#define PUSH_RULE_3 s_pop(stack); s_push(stack, LL_BRACKET_RIGHT); s_push(stack, LL_PARAMS); s_push(stack, LL_BRACKET_LEFT)
...
#define PUSH_RULE_16 s_pop(stack); s_push(stack, LL_ARGS); s_push(stack, LL_INPUTS)
#define PUSH_RULE_17 s_pop(stack); s_push(stack, LL_ARGS); s_push(stack, LL_INPUTI)
#define PUSH_RULE_18 s_pop(stack); s_push(stack, LL_ARGS); s_push(stack, LL_INPUTF)
#define PUSH_RULE_19 s_pop(stack); s_push(stack, LL_ARGS); s_push(stack, LL_LENGHT)
#define PUSH_RULE_20 s_pop(stack); s_push(stack, LL_ARGS); s_push(stack, LL_SUBSTR)
#define PUSH_RULE_21 s_pop(stack); s_push(stack, LL_ARGS); s_push(stack, LL_ORD)
#define PUSH_RULE_22 s_pop(stack); s_push(stack, LL_ARGS); s_push(stack, LL_CHR)
#define PUSH_RULE_23 s_pop(stack); s_push(stack, LL_EXPRESSION)
#define PUSH_RULE_24 s_pop(stack)
#define PUSH_RULE_25 s_pop(stack)
#define PUSH_RULE_26 s_pop(stack); s_push(stack, LL_BRACKET_RIGHT); s_push(stack, LL_ARGS); s_push(stack, LL_BRACKET_LEFT)
#define PUSH_RULE_27 s_pop(stack); s_push(stack, LL_ARGS_N); s_push(stack, LL_VALUE)
#define PUSH_RULE_28 s_pop(stack); s_push(stack, LL_ARGS_N); s_push(stack, LL_VALUE); s_push(stack, LL_COMMA)
#define PUSH_RULE_29 s_pop(stack)
#define PUSH_RULE_30 s_pop(stack); s_push(stack, LL_INT)

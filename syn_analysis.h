...
//#define PUSH_RULE_9 s_pop(stack); s_push(stack, LL_END); s_push(stack, LL_EOL); s_push(stack, LL_STATEMENT); s_push(stack, LL_ELSE); s_push(stack, LL_EOL); s_push(stack, LL_STATEMENT); s_push(stack, LL_EOL); s_push(stack, LL_THEN); s_push(stack, LL_EXPRESSION); s_push(stack, LL_IF)
#define PUSH_RULE_10 s_pop(stack); s_push(stack, LL_END); s_push(stack, LL_EOL); s_push(stack, LL_STATEMENT); s_push(stack, LL_EOL); s_push(stack, LL_DO); s_push(stack, LL_EXPRESSION); s_push(stack, LL_WHILE)
#define PUSH_RULE_11 s_pop(stack); s_push(stack, LL_DEF_ARGS); s_push(stack, LL_ID)
#define PUSH_RULE_12 s_pop(stack)
#define PUSH_RULE_13 s_pop(stack); s_push(stack, LL_DEFINE); s_push(stack, LL_SET)
...
#define PUSH_RULE_27 s_pop(stack); s_push(stack, LL_BRACKET_RIGHT); s_push(stack, LL_ARGS); s_push(stack, LL_BRACKET_LEFT)
